...
const char* ssid     = "NRLimhan"; //Wi-Fi SSID
const char* password = "qwertyuiop987"; //Wi-Fi Password

//Only used if using Static IP
IPAddress ip(192, 168, 1, 101); //IP
IPAddress gatewayDNS(192, 168, 1, 100);//DNS and Gewateway
...
void loop() {
  ...
  String url = "/ISCM/version.php?sensor1=787348&sensor2=7387"; //File or Server page you want to communicate with. along with data
