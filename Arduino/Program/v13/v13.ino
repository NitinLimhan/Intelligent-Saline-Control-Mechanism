...
String ssid="N";    // Wifi network SSID
...
boolean espdata(int unit_id,int flow_rate,float temperature,int pulserate,int salinelevel,int Econ){
  ...
  String getStr = "GET http://192.168.43.234/hospital/public/datalog/";   // prepare GET string
...
Serial1.println("AT+CWQAP");   // set esp8266 as client
showResponse(2000);

Serial1.println("AT+CIPSTATUS");   // set esp8266 as client
showResponse(2000);
...
boolean espdata_read(int unit_id ){
  ...
  String getStr = "GET http://192.168.43.234/hospital/public/patientdata/";   // prepare GET string
