...
boolean espdata(int unit_id,int flow_rate,float temperature,int pulserate,int salinelevel,int Econ){
  ...
  String getStr = "GET http://192.168.1.100/hospital/public/datalog/";   // prepare GET string
...
boolean espdata_read(int unit_id ){
  ...
  String getStr = "GET http://192.168.1.100/hospital/public/patientdata/";   // prepare GET string
